        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="login_box_img">
                    <img class="img-fluid" src="${pageContext.request.contextPath}/user/img/login.jpg" alt="">
                    <div class="hover">
            ...
            <div class="col-lg-6">
                <div class="login_form_inner">
                    <h3>Đăng nhập</h3>
                    <form class="row login_form" action="/login" method="post" id="contactForm1"
                          novalidate="novalidate">
                        <div class="col-md-12 form-group">
                            <p style="color: red">${message}</p>
                            <input type="text" class="form-control" id="name" name="nameAccount" placeholder="Username"
                                   onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
                            <p id="error"></p>
                        </div>
                        <div class="col-md-12 form-group">
                            <input type="password" class="form-control" id="pass" name="passAccount"
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <c:if test="account == null"><c:out
                                    value="${request.message}">"Sai thông tin tài khoản"</c:out></c:if>
...
<script>
    ...
    form.addEventListener("submit", function (event) {
        ...
        const input1 = document.getElementById("pass").value;
        const pattern = /^\s*$/;

        if (pattern.test(input)) {
            event.preventDefault();
            document.getElementById("error").innerHTML = "Vui lòng nhập đúng tên tài khoản";
        }
        if (pattern.test(input1)) {
            event.preventDefault();
            document.getElementById("error1").innerHTML = "Vui lòng nhập đúng mật khẩu";
        }
    });
